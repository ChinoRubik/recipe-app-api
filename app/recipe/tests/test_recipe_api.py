...
class PrivateRecipeAPITest(TestCase):
    """Test anthenticated API requests"""
    ...
    def test_retrieve_recipes(self):
        """Test retrieving a lis of recipes"""
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'https://differente.com/a.pdf',
    ...
    def test_recipe_other_users_recipe_error(self):
        """Test trying to delete another user recipe giver error."""
    ...
    def test_update_recipe_assign_tag(self):
        """Test assignin ane existing tag when updating a recipe"""
    ...
    def test_create_ingredient_on_update(self):
        ...
        payload = {'ingredients': [{'name': 'Melon'}]}
        url = detail_url(recipe.id)
        res = self.client.patch(url, payload, format='json')

        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(user=self.user, name='Melon')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Posh Beand on Toast')
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        ...
        url = image_upload_url(self.recipe.id)
        payload = {'image': 'notdsfhjdksajfdsa'}
        res = self.client.post(url, payload, format='multipart')
